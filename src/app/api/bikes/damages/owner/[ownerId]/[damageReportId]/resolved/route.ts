// src/api/bikes/damages/owner/[ownerId]/[damageReportId]/resolved/route.ts
import { NextResponse, NextRequest } from "next/server";
import prisma from "@/lib/prisma";
import { sendNotification } from "@/helpers/sendNotification";

export async function PUT(request: NextRequest, context: { params: Promise<{ ownerId: string, damageReportId: string }> }) {
    try {
